...
![_](assets/arvores.webp)

![https://www.cureffi.org/2014/08/27/git-tutorial](assets/diagrama.webp)
...
- Se estiver trabalhando com várias máquinas, ao acessar uma máquina e tentar dar o commit, o git vai avisar que já existem atualizações remotas. Lembre de sempre dar o `git pull origin main` antes de trabalhar numa nova pasta.
