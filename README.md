...
- [ ] `@wiki/competencias   eval=none gcs=1  ` [Competências trabalhadas](wiki/competencias/README.md) <!-- review=ok -->
- [ ] `@wiki/futuros        eval=none gcs=1  ` [Trabalhos futuros](wiki/trabalhos_futuros/README.md) <!-- review=ok -->
- [ ] `@wiki/git            eval=none gcs=1  ` [[GUIDE] Introdução ao git](wiki/git/README.md) <!-- review=ok -->
- [ ] `@wiki/relacionamento eval=none gcs=1  ` [[GUIDE] Relacionamentos](wiki/relacionamento/README.md) <!-- review=ok -->
- [ ] `@wiki/uml            eval=none gcs=1  ` [[GUIDE] Relacionamentos Resumo](wiki/uml/README.md) <!-- review=ok -->
- [ ] `@wiki/relatorio      eval=none gcs=1  ` [[GUIDE] Como fazer os códigos e relatórios](wiki/relatorio/README.md) <!-- review=ok -->
- [ ] `@wiki/atividade      eval=none gcs=1  ` [[GUIDE] Padrão para atividades de código](wiki/atividade_codigo/README.md) <!-- review=ok -->
- [ ] `@wiki/main           eval=none gcs=1  ` [[GUIDE] Criando a Main](wiki/main/README.md) <!-- review=ok -->

## Classes e Objetos <!-- @intro -->

- [ ] `@wiki/intro        eval=none gcs=1  ` [Introdução Classes e Objetos](wiki/intro/README.md) <!-- review=ok -->
...
- [ ] `@labs/toalha          eval=self gcs=2  ` [[GUIDE] Toalha que enxuga](labs/toalha/README.md) <!-- review=ok -->
...
- [ ] `@labs/animal          eval=diff gcs=2  ` [[GUIDE] Animal que morre](labs/animal/README.md) <!-- review=ok -->
...
- [ ] `@labs/enxugar         eval=diff gcs=212` [[TRAIN] Enxugar: Toalha com testes](labs/enxugar/README.md) <!-- review=ok -->
...
- [ ] `@labs/carro           eval=diff gcs=322` [[ALONE] Carro dirigível](labs/carro/README.md) <!-- review=ok -->
...
- [ ] `@labs/calculadora     eval=diff gcs=322` [[CHECK] Calculadora à bateria](labs/calculadora/README.md) <!-- review=ok -->
...
- [ ] `@wiki/access        eval=none gcs=1  ` [Introdução Encapsulamento e Invariantes](wiki/access/README.md) <!-- review=ok -->
  - Objetivos de aprendizagem:
...
- [ ] `@labs/chinela         eval=self gcs=1  ` [[GUIDE] Chinela de números pares](labs/chinela/README.md) <!-- review=ok -->
...
- [ ] `@labs/camisa          eval=self gcs=12 ` [[TRAIN] Camisa de tamanho fixo](labs/camisa/README.md) <!-- review=ok -->
...
- [ ] `@labs/roupa           eval=diff gcs=22 ` [[TRAIN] Roupa: camisa com testes](labs/roupa/README.md) <!-- review=ok -->
...
- [ ] `@labs/relogio         eval=diff gcs=332` [[ALONE] Hora 24h ou AM/PM](labs/relogio/README.md) <!-- review=ok -->
...
- [ ] `@wiki/agreg      eval=none gcs=1  ` [Introdução Agregação e Delegação](wiki/agreg/README.md) <!-- review=ok -->
  - Objetivos de aprendizagem:
...
- [ ] `@labs/motoca     eval=diff gcs=323` [[GUIDE] Criança andando de Motoca](labs/motoca/README.md) <!-- review=ok -->
...
- [ ] `@labs/grafite    eval=diff gcs=333` [[TRAIN] Lapiseira de um Grafite](labs/grafite/README.md) <!-- review=ok -->
...
- [ ] `@labs/motouber   eval=diff gcs=343` [[ALONE] Passeando e pagando o MotoUber](labs/motouber/README.md) <!-- review=ok -->
...
- [ ] `@wiki/agcha ` [Desafios de agregação e estados](wiki/agcha/README.md) <!-- review=ok -->
  - Objetivos de aprendizagem:
  ...
  - Princípio relacionado, quando necessário:
    ...
    - delegação: cada componente é responsável por suas próprias regras, e o coordenador apenas organiza a colaboração.
- [ ] `@labs/tamagotchi      eval=diff gcs=333` [[CHECK] Brinque até matar o Tamagotchi](labs/tamagotchi/README.md) <!-- review=ok -->
...
- [ ] `@labs/charger         eval=diff gcs=333` [[TRAIN] Notebook com bateria e carregador](labs/charger/README.md) <!-- review=ok -->
...
- [ ] `@wiki/arrays` [Introdução Coleções lineares](wiki/arrays/README.md)
  - Objetivos de aprendizagem:
...
- [ ] `@wiki/listas         eval=none gcs=1  ` [[GUIDE] Listas em Python](wiki/listas/README.md) <!-- review=ok -->
...
- [ ] `@labs/array           eval=diff gcs=2  ` [[GUIDE] Coleção de pessoas](labs/array/README.md) <!-- review=ok -->
...
- [ ] `@labs/contato         eval=diff gcs=212` [[TRAIN] Contato com telefones](labs/contato/README.md) <!-- review=ok -->
...
- [ ] `@labs/pula-pula       eval=diff gcs=1  ` [[TRAIN] Pula-pula com crianças](labs/pula-pula/README.md) <!-- review=ok -->
...
- [ ] `@labs/lapiseira       eval=diff gcs=1  ` [[ALONE] Lapiseira com tambor de grafites](labs/lapiseira/README.md) <!-- review=ok -->
...
- [ ] `@wiki/slots`[Introdução Posições fixas e ausência](wiki/slots/README.md)
  - Objetivos de aprendizagem:
...
- [ ] `@labs/cinema          eval=diff gcs=1  ` [[GUIDE] Cinema: posições fixas e ausência](labs/cinema/README.md) <!-- review=ok -->
...
- [ ] `@labs/budega          eval=diff gcs=2  ` [[TRAIN] Budega: fila e posições fixas](labs/budega/README.md) <!-- review=ok -->
...
- [ ] `@labs/junkfood        eval=diff gcs=1  ` [[ALONE] Junkfood: posições fixas e objeto vazio](labs/junkfood/README.md) <!-- review=ok -->
...
- [ ] `@wiki/exception` [Exceções](wiki/exception/README.md)
- [ ] `@labs/bermuda         eval=diff gcs=2  ` [[TRAIN] Bermuda: exceções para invariantes de tamanho](labs/bermuda/README.md)
...
- [ ] `@labs/fusca           eval=diff gcs=222` [[TRAIN] Fusca: posições, exceções e direção](labs/fusca/README.md)
...
- [ ] `@labs/porquinho       eval=diff gcs=1  ` [Guardando moedas e itens em um cofrinho](labs/porquinho/README.md)
...
- [ ] `@labs/tabuleiro       eval=diff gcs=1  ` [[CHECK] Tabuleiro: coleções na simulação de turnos](labs/tabuleiro/README.md)
