...
- [ ] `@+competencias   eval=none gain=0 cost=1 size=1` [Competências trabalhadas](wiki/competencias/README.md)
- [ ] `@+futuros        eval=none gain=0 cost=1 size=1` [Trabalhos futuros](wiki/trabalhos_futuros/README.md)
- [ ] `@+git            eval=none gain=1 cost=1 size=1` [[GUIDE] Introdução ao git](wiki/git/README.md)
- [ ] `@+relacionamento eval=none gain=0 cost=1 size=1` [[GUIDE] Relacionamentos](wiki/relacionamento/README.md)
- [ ] `@+uml            eval=none gain=0 cost=1 size=1` [[GUIDE] Relacionamentos Resumo](wiki/uml/README.md)
- [ ] `@+relatorio      eval=none gain=0 cost=1 size=1` [[GUIDE] Como fazer os códigos e relatórios](wiki/relatorio/README.md)
- [ ] `@+atividade      eval=none gain=0 cost=1 size=1` [[GUIDE] Padrão para atividades de código](wiki/atividade_codigo/README.md)
- [ ] `@+main           eval=none gain=0 cost=1 size=1` [[GUIDE] Criando a Main](wiki/main/README.md)
...
- [ ] `@toalha          eval=self gain=2 cost=1 size=1` [[GUIDE] Toalha que enxuga](labs/toalha/README.md)
...
- [ ] `@animal          eval=diff gain=2 cost=1 size=1` [[GUIDE] Animal que morre](labs/animal/README.md)
...
- [ ] `@enxugar         eval=diff gain=2 cost=1 size=2` [[TRAIN] Enxugar: Toalha com testes](labs/enxugar/README.md)
...
- [ ] `@carro           eval=diff gain=3 cost=2 size=2` [[ALONE] Carro dirigível](labs/carro/README.md)
...
- [ ] `@calculadora     eval=diff gain=3 cost=2 size=2` [[CHECK] Calculadora à bateria](labs/calculadora/README.md)
...
- [ ] `@chinela         eval=self gain=1 cost=1 size=1` [[GUIDE] Chinela de números pares](labs/chinela/README.md)
...
- [ ] `@camisa          eval=self gain=1 cost=2 size=1` [[TRAIN] Camisa de tamanho fixo](labs/camisa/README.md)
...
- [ ] `@roupa           eval=diff gain=2 cost=2 size=1` [[TRAIN] Roupa: camisa com testes](labs/roupa/README.md)
...
- [ ] `@relogio         eval=diff gain=3 cost=3 size=2` [[ALONE] Hora 24h ou AM/PM](labs/relogio/README.md)
...
- [ ] `@motoca          eval=diff gain=3 cost=2 size=3` [[GUIDE] Criança andando de Motoca ](labs/motoca/README.md)
...
- [ ] `@grafite         eval=diff gain=3 cost=3 size=3` [[TRAIN] Lapiseira de um Grafite](labs/grafite/README.md)
...
- [ ] `@motouber        eval=diff gain=3 cost=4 size=3` [[ALONE] Passeando e pagando o MotoUber](labs/motouber/README.md)
...
- [ ] `@tamagotchi      eval=diff gain=3 cost=3 size=3` [[CHECK] Brinque até matar o Tamagotchi](labs/tamagotchi/README.md)
...
- [ ] `@charger         eval=diff gain=3 cost=3 size=3` [[TRAIN] Notebook com bateria e carregador](labs/charger/README.md)
...
- [ ] `@+listas         eval=none gain=1 cost=1 size=1` [[GUIDE] Listas em Python](wiki/listas/README.md)
...
- [ ] `@array           eval=diff gain=2 cost=1 size=1` [[GUIDE] Coleção de pessoas](labs/array/README.md)
...
- [ ] `@contato         eval=diff gain=2 cost=1 size=2` [[TRAIN] Contato com telefones](labs/contato/README.md)
...
- [ ] `@pula-pula       eval=diff gain=1 cost=1 size=1` [[TRAIN] Pula-pula com crianças](labs/pula-pula/README.md)
...
- [ ] `@lapiseira       eval=diff gain=1 cost=1 size=1` [[ALONE] Lapiseira com tambor de grafites](labs/lapiseira/README.md)
...
- [ ] `@cinema          eval=diff gain=1 cost=1 size=1` [[GUIDE] Cinema: posições fixas e ausência](labs/cinema/README.md)
...
- [ ] `@budega          eval=diff gain=2 cost=1 size=1` [[TRAIN] Budega: fila e posições fixas](labs/budega/README.md)
...
- [ ] `@junkfood        eval=diff gain=1 cost=1 size=1` [[ALONE] Junkfood: posições fixas e objeto vazio](labs/junkfood/README.md)
...
- [ ] `@bermuda         eval=diff gain=2 cost=1 size=1` [[TRAIN] Bermuda: exceções para invariantes de tamanho](labs/bermuda/README.md)
...
- [ ] `@fusca           eval=diff gain=2 cost=2 size=2` [[TRAIN] Fusca: posições, exceções e direção](labs/fusca/README.md)
...
- [ ] `@porquinho       eval=diff gain=1 cost=1 size=1` [Guardando moedas e itens em um cofrinho](labs/porquinho/README.md)
...
- [ ] `@tabuleiro       eval=diff gain=1 cost=1 size=1` [[CHECK] Tabuleiro: coleções na simulação de turnos](labs/tabuleiro/README.md)
...
___
- [ ] `@agenda          eval=diff gain=3 cost=2 size=3` [Agenda: contatos por identidade em um mapa](labs/agenda/README.md)
...
- [ ] `@agiota          eval=diff gain=1 cost=1 size=1` [Gerencie os empréstimos do agiota](labs/agiota/README.md)
...
- [ ] `@petshop         eval=diff gain=1 cost=1 size=1` [Meu Petshop](labs/petshop/README.md)
...
___
- [ ] `@favoritos       eval=diff gain=1 cost=1 size=1` [[TRAIN] Favoritos: índice secundário e consistência](labs/favoritos/README.md)
...
- [ ] `@ligacao         eval=diff gain=1 cost=1 size=1` [[TRAIN] Ligação: composição para histórico e ranking](labs/ligacao/README.md)
...
___
- [ ] `@zoo             eval=self gain=1 cost=1 size=1` [[ALONE] Zoo: contrato comum e comportamento polimórfico](labs/zoo/README.md)
...
- [ ] `@pagamento       eval=self gain=1 cost=1 size=1` [[TRAIN] Pagamento: composição de métodos de pagamento](labs/pagamento/README.md)
...
- [ ] `@shapes          eval=diff gain=2 cost=1 size=1` [[TRAIN] Shapes: interface e substituição geométrica](labs/shapes/README.md)
...
- [ ] `@estacionamento  eval=diff gain=3 cost=1 size=1` [Estacionamento — polimorfismo por tipo de veículo](labs/estacionamento/README.md)
...
- [ ] `@cofre           eval=diff gain=3 cost=1 size=1` [Cofre — polimorfismo por contrato de valor](labs/cofre/README.md)
...
- [ ] `@cadastro        eval=diff gain=3 cost=1 size=1` [Cadastro — contas com regras polimórficas](labs/cadastro/README.md)
...
- [ ] `@twitter         eval=diff gain=4 cost=2 size=2` [Twitter — colaboração entre usuários e timelines](labs/twitter/README.md)
...
- [ ] `@salario         eval=diff gain=3 cost=2 size=1` [Salário — regras de cálculo polimórficas](labs/salario/README.md)
...
- [ ] `@mensagem        eval=diff gain=2 cost=1 size=1` [Mensagem — inbox e leitura destrutiva](labs/mensagem/README.md)
...
- [ ] `@comunicador     eval=diff gain=3 cost=2 size=1` [Comunicador — envio autorizado por composição](labs/comunicador/README.md)
...
- [ ] `@paciente        eval=diff gain=2 cost=1 size=1` [Paciente — vínculos bidirecionais no hospital](labs/paciente/README.md)
...
- [ ] `@whatsapp        eval=diff gain=3 cost=2 size=2` [WhatsApp — grupos e estado de leitura por participante](labs/whatsapp/README.md)
...
- [ ] `@grupo           eval=diff gain=3 cost=2 size=2` [Grupo — contrato comum para chats](labs/grupo/README.md)
...
- [ ] `@vetores         eval=diff gain=1 cost=1 size=1` [Vetores — coleção linear e índices](labs/vetores/README.md)
...
- [ ] `@anotacoes       eval=diff gain=2 cost=1 size=1` [Anotações — sessão e notas privadas](labs/anotacoes/README.md)
...
- [ ] `@trem            eval=diff gain=1 cost=1 size=1` [Trem — composição e alocação de passageiros](labs/trem/README.md)
- [ ] `@produto         eval=diff gain=1 cost=1 size=1` [Produto — Composite e Decorator](labs/produto/README.md)
- [ ] `@git_pratica     eval=none gain=1 cost=1 size=1` [Git — fluxo de trabalho e recuperação](labs/git_pratica/README.md)
...
- [ ] `@tarifas         eval=diff gain=3 cost=2 size=1` [Operações de saque, depósito, extrato](labs/tarifas/README.md)
